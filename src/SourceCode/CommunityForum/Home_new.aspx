...
<div id="tooplate_wrapper">
 ...
 <asp:CheckBox ID="CheckBox4" runat="server" />           Question&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button2" runat="server" Text="Reset Filters" OnClick="resetFilters" />
        </td>            
     ...
     <asp:TemplateField Visible="false" HeaderText="Tags">
                  <ItemTemplate>
                <asp:Label ID="ID4" Visible="false" runat="server" Text='<%#Eval("tagname") %>'></asp:Label>
               </ItemTemplate>             
        </asp:TemplateField>

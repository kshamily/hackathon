        ...
        try
        {
            ...
            else
            {
                ...
                if (result > 0)
                {
                    ...
                    string subject = "Community Forum Account";
                    string body = "Your account has been created with Community Forum. Please use the username :" + username + " and password : " + password + " to login";
